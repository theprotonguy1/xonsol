  ...
  return (
    <section id="utility" className="mt-5 mb-[70px]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4">
        <motion.div variants={slideIn('left', 'spring')} className="flex-grow">
          <UtilityBox bgColor="yellow-200" text="Discord Subscription Bot" index={0} />
        </motion.div>
        <motion.div variants={slideIn('right', 'spring')} className="flex-grow">
